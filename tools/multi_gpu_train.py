...
from libs.networks import build_whole_network_v2 as build_whole_network
from data.io.read_tfrecord_v2 import next_batch
...
def train():
    ...
    with tf.Graph().as_default(), tf.device('/cpu:0'):
        ...
        with tf.name_scope('get_batch'):
            img_name_batch, rgb_img_batch, gtboxes_and_label_batch, num_objects_batch, img_h_batch, img_w_batch, ir_img_batch = \
        ...
        for i in range(cfgs.NUM_GPU):
            ...
            inputs_list.append([rgb_img, gtboxes_and_label, num_objects, ir_img, img_h, img_w])
