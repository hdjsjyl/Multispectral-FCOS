...
def multi_flip_left_to_right(rgb_img_tensor, ir_img_tensor, gtboxes_and_label):
    ...
    return rgb_img_tensor, ir_img_tensor, tf.transpose(tf.stack([new_xmin, ymin, new_xmax, ymax, label], axis=0))


def multi_random_flip_left_right(rgb_img_tensor, ir_img_tensor, gtboxes_and_label):
    rgb_img_tensor, ir_img_tensor, gtboxes_and_label= tf.cond(tf.less(tf.random_uniform(shape=[], minval=0, maxval=1), 0.5),
                                            lambda: multi_flip_left_to_right(rgb_img_tensor, ir_img_tensor, gtboxes_and_label),
                                            lambda: (rgb_img_tensor, ir_img_tensor, gtboxes_and_label))

    return rgb_img_tensor, ir_img_tensor,  gtboxes_and_label
