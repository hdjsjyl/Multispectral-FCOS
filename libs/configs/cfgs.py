...
RGB_FIXED_BLOCKS = 0  # allow 0~3
IR_FIXED_BLOCKS = 0  # allow 0~3
...
EPSILON = 1e-5
MOMENTUM = 0.9
LR = 1e-4 * NUM_GPU * BATCH_SIZE
DECAY_STEP = [SAVE_WEIGHTS_INTE*24, SAVE_WEIGHTS_INTE*32, SAVE_WEIGHTS_INTE*40]
MAX_ITERATION = SAVE_WEIGHTS_INTE*20
WARM_SETP = int(0.125 * SAVE_WEIGHTS_INTE)

# -------------------------------------------- Data_preprocess_config
DATASET_NAME = 'kaist'
RGB_PIXEL_MEAN = [90.5241, 84.2702, 74.7512]  # R, G, B. In tf, channel is RGB. In openCV, channel is BGR
IR_PIXEL_MEAN = [44.2455, 42.3252, 44.2455]  # R, G, B. In tf, channel is RGB. In openCV, channel is BGR
