...
def resnet_base(rgb_img_batch, ir_img_batch, scope_name, is_training=True):
    ...
    if scope_name == 'resnet_v1_50':
        ...
        raise NotImplementedError('We only support resnet_v1_50 or resnet_v1_50. ')
    ...
    rgb_end_points_C2 = end_points_C2_rgb['{}/block1/unit_2/bottleneck_v1'.format("RGB/resnet_v1_50/RGB/"+org_scope_name)]

    rgb_end_points_C3 = end_points_C3_rgb['{}/block2/unit_3/bottleneck_v1'.format("RGB/resnet_v1_50/RGB/"+org_scope_name)]

    rgb_end_points_C4 = end_points_C4_rgb['{}/block3/unit_{}/bottleneck_v1'.format("RGB/resnet_v1_50/RGB/"+org_scope_name, middle_num_units-1)]

    rgb_end_points_C5 = end_points_C5_rgb['{}/block4/unit_3/bottleneck_v1'.format("RGB/resnet_v1_50/RGB/"+org_scope_name)]



    ir_end_points_C2 = end_points_C2_ir['{}/block1/unit_2/bottleneck_v1'.format("IR/resnet_v1_50/IR/"+org_scope_name)]

    ir_end_points_C3 = end_points_C3_ir['{}/block2/unit_3/bottleneck_v1'.format("IR/resnet_v1_50/IR/"+org_scope_name)]

    ir_end_points_C4 = end_points_C4_ir['{}/block3/unit_{}/bottleneck_v1'.format("IR/resnet_v1_50/IR/"+org_scope_name, middle_num_units-1)]

    ir_end_points_C5 = end_points_C5_ir['{}/block4/unit_3/bottleneck_v1'.format("IR/resnet_v1_50/IR/"+org_scope_name)]
    ...
    pyramid_dict_multi = {}
    with tf.variable_scope('build_pyramid_multi'):
        with slim.arg_scope([slim.conv2d], weights_regularizer=slim.l2_regularizer(cfgs.WEIGHT_DECAY),
            ...
            for i in range(3):
                ...
                pyramid_dict_multi['P{}'.format(5-i)] = fm_3x3_conv

            p6 = slim.conv2d(pyramid_dict_multi['P5'],
                             num_outputs=conv_channels, kernel_size=[3, 3], padding="SAME",
                             stride=2, scope='p6_conv')
            pyramid_dict_multi['P6'] = p6
            ...
            pyramid_dict_multi['P7'] = p7

    # for level in range(7, 1, -1):
    #     add_heatmap(pyramid_dict_multi['P%d' % level], name='Layer%d/P%d_heat' % (level, level))


    feature_dict = {'C2': ir_end_points_C2,
                    'C3': ir_end_points_C3,
                    'C4': ir_end_points_C4,
                    'C5': ir_end_points_C5,
                    # 'C5': end_points_C5['{}/block4'.format(scope_name)],
    ...
    pyramid_dict_ir = {}
    with tf.variable_scope('build_pyramid_ir'):
        with slim.arg_scope([slim.conv2d], weights_regularizer=slim.l2_regularizer(cfgs.WEIGHT_DECAY),
                            activation_fn=None, normalizer_fn=None):
            ...
            for i in range(3):
                ...
                fm_3x3_conv = slim.conv2d(fm_1x1_conv,
                                          num_outputs=conv_channels, kernel_size=[3, 3], padding="SAME",
                                          stride=1, scope='p{}_3x3_conv'.format(5 - i))
                pyramid_dict_ir['P{}'.format(5-i)] = fm_3x3_conv

            p6 = slim.conv2d(pyramid_dict_ir['P5'],
                             num_outputs=conv_channels, kernel_size=[3, 3], padding="SAME",
                             stride=2, scope='p6_conv')
            pyramid_dict_ir['P6'] = p6
            ...
            pyramid_dict_ir['P7'] = p7



    feature_dict = {'C2': rgb_end_points_C2,
                    'C3': rgb_end_points_C3,
                    'C4': rgb_end_points_C4,
                    'C5': rgb_end_points_C5,
                    # 'C5': end_points_C5['{}/block4'.format(scope_name)],
                    }


    pyramid_dict_rgb = {}
    with tf.variable_scope('build_pyramid_rgb'):
        with slim.arg_scope([slim.conv2d], weights_regularizer=slim.l2_regularizer(cfgs.WEIGHT_DECAY),
                            activation_fn=None, normalizer_fn=None):
            ...
            for i in range(3):
                ...
                fm_3x3_conv = slim.conv2d(fm_1x1_conv,
                                          num_outputs=conv_channels, kernel_size=[3, 3], padding="SAME",
                                          stride=1, scope='p{}_3x3_conv'.format(5 - i))
                pyramid_dict_rgb['P{}'.format(5-i)] = fm_3x3_conv

            p6 = slim.conv2d(pyramid_dict_rgb['P5'],
                             num_outputs=conv_channels, kernel_size=[3, 3], padding="SAME",
                             stride=2, scope='p6_conv')
            pyramid_dict_rgb['P6'] = p6
            ...
            pyramid_dict_rgb['P7'] = p7


    return pyramid_dict_multi, pyramid_dict_rgb, pyramid_dict_ir
