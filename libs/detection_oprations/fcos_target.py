...
def get_seg_target_batch(seg_batch, fm_size_list):
    seg_target_batch = []
    seg_target = cv2.resize(seg_batch[0], (fm_size_list[1], fm_size_list[0]))
    seg_target_batch.append(seg_target)
    seg_target = cv2.resize(seg_batch[1], (fm_size_list[1], fm_size_list[0]))
    seg_target_batch.append(seg_target)
    return np.array(seg_target_batch, np.int32)
